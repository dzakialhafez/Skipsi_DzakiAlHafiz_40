    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm mb-4">
                <div class="card-header font-weight-bold text-primary">Edit Data 
                </div>
                        ...
                        <form action="{{route('employe.update',['id'=>$employe->id])}}" method="POST">
                            ...
                            @method('put')
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="class" class="form-control" id="class" aria-describedby="classHelp" value="{{$employe->class}}">
                                </div>
                                <div class="form-group">
