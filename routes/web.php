...
Route::middleware(['auth.basic'])->prefix('dashboard')->group(function(){
    ...
    Route::get('employe/{id}','EmployeController@index')->name('employe.show');
    ...
    Route::get('grupkriteria','grupkriteriaController@index')->name('grupkriteria');
    Route::post('grupkriteria/store','grupkriteriaController@store')->name('grupkriteria.store');
    Route::get('grupkriteria/{id}','grupkriteriaController@show')->name('grupkriteria.show');
    Route::get('grupkriteria/{id}/edit','grupkriteriaController@edit')->name('grupkreteria.edit');
    Route::put('grupkriteria/{id}/update','grupkriteriaController@update')->name('grupkriteria.update');
    Route::delete('grupkriteria/{grupkriteria}/delete','grupkriteriaController@destroy')->name('grupkriteria.delete');
